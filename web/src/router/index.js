...
const routes = [
  ...
  { path: '/workflows', name: 'workflows', component: () => import('@/views/WorkflowListView.vue'), meta: { title: '工作流', auth: true } },
  { path: '/workflow/:id?', name: 'workflow', component: () => import('@/views/WorkflowView.vue'), meta: { title: '工作流画布', auth: true } },
